...
Note que o jogo pode não ter ganhador em muitas situações; nesses casos,
as cartas distribuídas são devolvidas ao baralho, que é embaralhado e uma nova partida é iniciada

Um jogador já recebeu duas das cartas que deve receber, e conhece seus valores.
Sua tarefa é escrever um programa para determinar qual o valor da terceira carta que\
maximiza a probabilidade de esse jogador ganhar o jogo.

A entrada consiste de uma ´unica linha que contém dois inteiros,\
A (1 ≤ A ≤ 13) e B (1 ≤ B ≤ 13) indicando os valores das duas primeiras cartas recebidas.
